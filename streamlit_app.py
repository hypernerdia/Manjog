...
if mode == "🤖 Chatbot":
    ...
    st.markdown(
        ...
        .chatbot-bg {
            ...
            background: url('https://github.com/hypernerdia/Manjog/blob/55e0993de7c4ca7ad75b48960fed7f57112a1853/assets/chatbot_bg.jpg.png') no-repeat center center fixed;
